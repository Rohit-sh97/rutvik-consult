      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a
                href="https://www.instagram.com/rutvik__deoke?utm_source=ig_web_button_share_sheet&igsh=MWc3MXEyM2thaHY4ag=="
                target="_blank"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            <Link href="/T&C/privacy" className="text-gray-400 hover:text-green-500 text-sm transition-colors">
              Privacy Policy
            </Link>
            <Link href="/T&C/terms" className="text-gray-400 hover:text-green-500 text-sm transition-colors">
              Terms & Conditions
            </Link>
            <Link href="/T&C/refund" className="text-gray-400 hover:text-green-500 text-sm transition-colors">
              Refund Policy
            </Link>
            <Link href="/T&C/cancellation" className="text-gray-400 hover:text-green-500 text-sm transition-colors">
              Cancellation Policy
            </Link>
          </div>
        </div>
